...
## do t create new user 
resource "aws_iam_user" "myUser" {
    name = var.aws_user_name
}

resource "aws_iam_policy" "glacierPolicy" {
    name = "glacier"
...
#binding policy to the user
resource "aws_iam_policy_attachment" "policyBind1" {
    name = "attachment1"
    users = [aws_iam_user.myUser.name]
    policy_arn = aws_iam_policy.glacierPolicy.arn
}


resource "aws_iam_policy" "ec2PolicyWrite_p1" {
    name = "ec2_write_p1"
...
resource "aws_iam_policy" "ec2PolicyWrite_p2" {
    name = "ec2_write_p2"
...
resource "aws_iam_policy_attachment" "policyBindEc2p1" {
    name = "attachment_ec2p1"
    users = [aws_iam_user.myUser.name]
    policy_arn = aws_iam_policy.ec2PolicyWrite_p1.arn
}


resource "aws_iam_policy_attachment" "policyBindEc2p2" {
    name = "attachment_ec2p2"
    users = [aws_iam_user.myUser.name]
    policy_arn = aws_iam_policy.ec2PolicyWrite_p2.arn
}
